...
import Historia from "../../Mocks/Historia.json";
import IconWha from "../../Global/IconWha";
const About = () => {
  return (
    <section>
      <div className="w-5/6 mx-auto">
        {Historia.historia.slice(0, 1).map((item) => {
          return (
            <div key={item.title}>
        ...
        <div className="bg-primary-500 text-white text-2xl my-10 flex justify-end py-10 px-5 rounded-lg">
        ...
        <div>
          {Historia.historia.slice(1).map((item) => {
            return (
              <div key={item.title} className="mb-10">
                <h1 className="text-4xl text-gray-600 border-b border-primary-500 py-4 mb-2">
                  {item.title}
                </h1>
                <p>{item.text}</p>
              </div>
